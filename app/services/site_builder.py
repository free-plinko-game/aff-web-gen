...
# Inline SVG payment method icons (monochrome, ~28x18 viewBox)
PAYMENT_ICON_MAP = {
    'visa': Markup('<svg viewBox="0 0 28 18" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="28" height="18" rx="2" fill="#1a1f71" opacity="0.15"/><text x="14" y="12" text-anchor="middle" font-size="7" font-weight="700" font-family="sans-serif" fill="#1a1f71">VISA</text></svg>'),
    'mastercard': Markup('<svg viewBox="0 0 28 18" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="11" cy="9" r="6" fill="#eb001b" opacity="0.25"/><circle cx="17" cy="9" r="6" fill="#f79e1b" opacity="0.25"/></svg>'),
    'maestro': Markup('<svg viewBox="0 0 28 18" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="11" cy="9" r="6" fill="#0099df" opacity="0.25"/><circle cx="17" cy="9" r="6" fill="#000" opacity="0.15"/></svg>'),
    'bank-transfer': Markup('<svg viewBox="0 0 28 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M14 2l9 4H5l9-4z" fill="#64748b" opacity="0.4"/><rect x="7" y="7" width="2" height="6" rx="0.5" fill="#64748b" opacity="0.4"/><rect x="13" y="7" width="2" height="6" rx="0.5" fill="#64748b" opacity="0.4"/><rect x="19" y="7" width="2" height="6" rx="0.5" fill="#64748b" opacity="0.4"/><rect x="5" y="14" width="18" height="2" rx="0.5" fill="#64748b" opacity="0.4"/></svg>'),
    'skrill': Markup('<svg viewBox="0 0 28 18" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="14" cy="9" r="7" fill="#862165" opacity="0.2"/><text x="14" y="12" text-anchor="middle" font-size="8" font-weight="700" font-family="sans-serif" fill="#862165">S</text></svg>'),
    'neteller': Markup('<svg viewBox="0 0 28 18" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="14" cy="9" r="7" fill="#3bab37" opacity="0.2"/><text x="14" y="12" text-anchor="middle" font-size="8" font-weight="700" font-family="sans-serif" fill="#3bab37">N</text></svg>'),
    'paypal': Markup('<svg viewBox="0 0 28 18" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="14" cy="9" r="7" fill="#003087" opacity="0.2"/><text x="14" y="12" text-anchor="middle" font-size="7" font-weight="700" font-family="sans-serif" fill="#003087">PP</text></svg>'),
    'bitcoin': Markup('<svg viewBox="0 0 28 18" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="14" cy="9" r="7" fill="#f7931a" opacity="0.2"/><text x="14" y="12.5" text-anchor="middle" font-size="9" font-weight="700" font-family="sans-serif" fill="#f7931a">&#x20BF;</text></svg>'),
    'opay': Markup('<svg viewBox="0 0 28 18" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="14" cy="9" r="7" fill="#1dcf9f" opacity="0.2"/><text x="14" y="12" text-anchor="middle" font-size="7" font-weight="700" font-family="sans-serif" fill="#1dcf9f">OPay</text></svg>'),
    'palmpay': Markup('<svg viewBox="0 0 28 18" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="14" cy="9" r="7" fill="#8b5cf6" opacity="0.2"/><text x="14" y="12" text-anchor="middle" font-size="8" font-weight="700" font-family="sans-serif" fill="#8b5cf6">P</text></svg>'),
    'm-pesa': Markup('<svg viewBox="0 0 28 18" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="14" cy="9" r="7" fill="#4caf50" opacity="0.2"/><text x="14" y="12" text-anchor="middle" font-size="8" font-weight="700" font-family="sans-serif" fill="#4caf50">M</text></svg>'),
    'mpesa': Markup('<svg viewBox="0 0 28 18" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="14" cy="9" r="7" fill="#4caf50" opacity="0.2"/><text x="14" y="12" text-anchor="middle" font-size="8" font-weight="700" font-family="sans-serif" fill="#4caf50">M</text></svg>'),
    'mtn-mobile-money': Markup('<svg viewBox="0 0 28 18" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="14" cy="9" r="7" fill="#ffcc00" opacity="0.25"/><text x="14" y="12" text-anchor="middle" font-size="6" font-weight="700" font-family="sans-serif" fill="#996600">MTN</text></svg>'),
    'mtn': Markup('<svg viewBox="0 0 28 18" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="14" cy="9" r="7" fill="#ffcc00" opacity="0.25"/><text x="14" y="12" text-anchor="middle" font-size="6" font-weight="700" font-family="sans-serif" fill="#996600">MTN</text></svg>'),
}
